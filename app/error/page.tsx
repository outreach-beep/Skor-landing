...
function ErrorPageContent() {
  ...
  useEffect(() => {
    if (error === "OAuthAccountNotLinked") {
      setErrorMessage("Whoops, there may already be an account with that email.");
    } else {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full p-4">
        <div className="w-full max-w-lg bg-[#1F1A18E5]/40 backdrop-blur-sm bg-opacity-90 p-8 rounded-lg shadow-lg">
          ...
          <Link href="/" className="block w-full">
            <button className="w-full font-chakra px-4 py-4 text-black text-xl font-bold uppercase bg-gradient-to-r from-[#EE5D4B] to-[#ED4732] hover:bg-gradient-to-r from-[#ED4732] to-[#EE5D4B] focus:outline-none focus:ring-2 focus:gradientEnd focus:ring-offset-2 transition-colors duration-200">
